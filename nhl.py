...
GAME_URL = 'https://site.api.espn.com/apis/site/v2/sports/hockey/nhl/summary' #?event=
SCOREBOARD_URL = 'https://site.api.espn.com/apis/site/v2/sports/hockey/nhl/scoreboard' #?dates=YYYYMMDD
...
if __name__ == "__main__":
    ...
    print(years)
    load_info = pipeline.run(headcount_source())
    print(load_info)